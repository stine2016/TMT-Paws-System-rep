    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        btnGetStarted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ctx, LoginActivityV2.class);
        ...
        switch (position)
        {
            case 0:
                ...
                title.setText("Temperature Data");
                desc.setText("Show temperature of the dog");
            ...
            case 1:
                ...
                desc.setText("See your pet locally or over the internet");
            ...
            case 2:
                ...
                title.setText("Modern Graphs");
                desc.setText("Every details you want to know");
                back.setVisibility(View.VISIBLE);
